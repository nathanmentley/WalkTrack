...
namespace WalkTrack.Framework.Common.ApiErrorResponses;

/// <summary>
/// </summary>
public sealed class ApiErrorResponseJsonV1Transcoder: BaseJsonTranscoder<ApiErrorResponse>, ITranscoder
{
