...
namespace WalkTrack.Server.Hosting.ExceptionFilters.Core;

/// <summary>
/// An abstract excpetion handler implementation to transform exceptions into http status codes.
/// </summary>
public class WalkTrackExceptionFilter: ExceptionFilterAttribute
{
    ...
    /// </param>
    public WalkTrackExceptionFilter(ILogger<WalkTrackExceptionFilter> logger, IEnumerable<IExceptionHandler> handlers)
    {
        _Logger = logger ??
