...
[Authorize("")]
[Route("v1/role")]
public sealed class UpdateRoleV1Controller: ControllerBase
{
    private readonly IRoleService _service;

    public UpdateRoleV1Controller(IRoleService service)
    {
        if (service is null)
        {
    ...
    public async Task<IActionResult> Create([FromBody] Role role, CancellationToken cancellationToken)
    {
        ...
        await _service.Update(GetAuthenticationContext(), role, cancellationToken);
