...
[Route("v1/permission")]
public sealed class UpdatePermissionV1Controller: ControllerBase
{
    private readonly IPermissionService _service;

    public UpdatePermissionV1Controller(IPermissionService service)
    {
        if (service is null)
        {
    ...
    public async Task<IActionResult> Create([FromBody] Permission permission, CancellationToken cancellationToken)
    {
        ...
        await _service.Update(GetAuthenticationContext(), permission, cancellationToken);
