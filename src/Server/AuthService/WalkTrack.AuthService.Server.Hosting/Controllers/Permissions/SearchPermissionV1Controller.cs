...
[ApiController]
[Authorize("search-permission")]
[Route("v1/permission")]
public sealed class SearchPermissionV1Controller: ControllerBase
{
    private readonly IPermissionService _service;

    public SearchPermissionV1Controller(IPermissionService service)
    {
        if (service is null)
        {
    ...
    [HttpGet]
    public async Task<IEnumerable<Permission>> Fetch(CancellationToken cancellationToken)
    {
