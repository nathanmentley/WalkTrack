...
/// <summary>
/// </summary>
internal sealed class RoleJsonV1Transcoder : BaseJsonTranscoder<Role>, ITranscoder
{
    ...
    public override JsonObject Encode(Role resource) =>
        new JsonObjectBuilder()
            .With("id", resource.Id)
            .With("name", resource.Name)
            .Build();

    public override Role Decode(JsonObject jsonObject) =>
        new Role()
        {
