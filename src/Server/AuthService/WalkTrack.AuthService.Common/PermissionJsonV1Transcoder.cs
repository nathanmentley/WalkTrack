...
/// <summary>
/// </summary>
internal sealed class PermissionJsonV1Transcoder : BaseJsonTranscoder<Permission>, ITranscoder
{
    ...
    public override JsonObject Encode(Permission resource) =>
        new JsonObjectBuilder()
            .With("id", resource.Id)
            .With("name", resource.Name)
            .Build();

    public override Permission Decode(JsonObject jsonObject) =>
        new Permission()
        {
