...
/// <summary>
/// </summary>
internal sealed class TokenJsonV1Transcoder : BaseJsonTranscoder<Token>, ITranscoder
{
    ...
    public override JsonObject Encode(Token resource) =>
        new JsonObjectBuilder()
            .With("id", resource.Id)
            .Build();

    public override Token Decode(JsonObject jsonObject) =>
        new Token()
        {
