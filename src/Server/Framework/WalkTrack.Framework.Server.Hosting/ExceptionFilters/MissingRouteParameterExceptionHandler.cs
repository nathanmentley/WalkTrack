...
/// <summary>
/// An excpetion handler for <see cref="MissingRouteParameterException"/>
/// </summary>
[ExcludeFromCodeCoverage]
internal sealed class MissingRouteParameterExceptionHandler: IExceptionHandler
{
    /// <summary>
    ...
    public bool CanHandle(Exception exception) =>
        exception is MissingRouteParameterException;

    public ApiErrorResponse BuildErrorResponse(Exception exception) =>
        new ApiErrorResponse()
        {
            StatusCode = StatusCode,
            Message = "Missing route parameter in request."
        };
}