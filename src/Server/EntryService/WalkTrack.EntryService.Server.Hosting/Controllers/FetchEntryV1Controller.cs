...
[ApiController]
[Authorize("fetch-entry")]
[Route("v1/entry/{id}")]
public sealed class FetchEntryV1Controller: ControllerBase
{
    private readonly IEntryService _service;

    public FetchEntryV1Controller(IEntryService service)
    {
        if (service is null)
        {
    ...
    [HttpGet]
    public async Task<Entry> Fetch([FromRoute] string id, CancellationToken cancellationToken)
    {
