...
/// <summary>
/// </summary>
internal sealed class ForgotPasswordJsonV1Transcoder : BaseJsonTranscoder<ForgotPassword>, ITranscoder
{
    ...
    public override JsonObject Encode(ForgotPassword resource) =>
        new JsonObjectBuilder()
            .With("email", resource.Email)
            .Build();

    public override ForgotPassword Decode(JsonObject jsonObject) =>
        new ForgotPassword()
        {
